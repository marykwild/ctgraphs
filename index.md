...
<iframe title="Pay ranges at CT state agencies varied in 2021" aria-label="Dot Plot" id="datawrapper-chart-E64Hd" src="https://datawrapper.dwcdn.net/E64Hd/4/" scrolling="no" frameborder="0" style="background: #FFFFFF; padding:10%; width: 0; min-width: 100% !important; border: none;" height="553"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
